...
gem "nyulibraries_deploy", :git => "git://github.com/NYULibraries/nyulibraries_deploy.git",  :tag => "v3.0.1"
...
gem "authpds-nyu", :git => "git://github.com/scotdalton/authpds-nyu.git", :tag => 'v0.2.13'
