...
gem "nyulibraries_deploy", git: "git://github.com/NYULibraries/nyulibraries_deploy.git",  tag: "v3.1.2"
...
gem "exlibris-nyu", git: "git://github.com/NYULibraries/exlibris-nyu.git", branch: 'qa'
