Feature: "Map" button for a Copy in Library
  ...
  @guest/el_croquis
  Scenario: A guest user viewing a New School University Center Main Collection journal
    Given I am not logged in
    And I am on the GetIt page for the title "El Croquis"
    Then I should see a blue "Map" button

  @user/el_croquis
  Scenario: A user viewing a New School University Center Main Collection journal
    Given I am logged in
    And I am on the GetIt page for the title "El Croquis"
    Then I should see a blue "Map" button
