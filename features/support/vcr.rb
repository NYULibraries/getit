...
VCR.cucumber_tags do |t|
  ...
  t.tag '@newschool_ezborrow_user/checked_out'#, allow_playback_repeats: true, record: :all
  ...
  t.tag '@user/unavailable_nyu'#, record: :new_episodes
  t.tag '@guest/unavailable_nyu'#, record: :new_episodes
